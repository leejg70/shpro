      ...
      <v-row class="pa-8 justify-center">
            ...
            <v-col cols="12">
              <v-window v-model="tab">
                ...
                <v-window-item value="tab-3">
                  <div class="text-center mb-6">
                    <h3 class="text-h3">What’s your purpose for use Able</h3>
                ...
                <v-window-item value="tab-6">
                  <v-alert type="success" variant="tonal" class="mb-4 with-border" icon="false" rounded="md">
                    <template v-slot:prepend>
                      <v-icon class="text-16">mdi-checkbox-marked-circle-outline</v-icon>
                    </template>
                    <div>All steps completed - you can now Login</div>
                  </v-alert>
                  <v-btn variant="flat" to="/auth/login1" color="primary" block>Login</v-btn>
                </v-window-item>
              </v-window>
            </v-col>
          </v-row>
        ...
        <v-col cols="12" class="text-center">
          <p class="text-h6 mb-0">
            ...
            <a href="/auth/login3" class="text-primary">Privacy Policy</a>
            and agree to the
