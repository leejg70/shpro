      ...
      <div class="cnt-group">
        ...
        <div class="cnt-text">
          <ul class="list-dot text-16">
            <li>운영 중인 스마트스토어의 모든 상품의 노출 순위 및 지표 확인을 빠르게 할 수 있습니다. 매일 새롭게 상승/하락한 내 상품 노출순위, 상세 인기지표, 순위 변화 추이까지 다양하에 활용해 보세요.</li>
            <li>궁금한 키워드 시장 분석을 자세히 분석해드립니다. 키워드와 관련된 다양한 추이와 특징, 인기 카테고리, 관련 키워드, 경쟁상품 및 등록정보까지 상세하게 확인해 보세요.</li>
