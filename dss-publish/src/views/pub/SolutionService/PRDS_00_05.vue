  ...
  <div class="sub-group">
    ...
    <div class="static-content">
      ...
      <div class="cnt-group">
        ...
        <div class="cnt-text">
          <div class="text-16">서로 다른 기관이 보유한 개인정보를 가명처리한 후 결합하여 가치 있는 새로운 정보를 얻는 것을 말합니다.<br />신용정보가 포함된 가명정보 결합은, 관련 법률에 따라 데이터전문기관만이 수행할 수 있습니다.<br />신한카드에 가명정보 결합을 요청하시면 최상의 결과물을 제공해드리겠습니다.</div>
        </div>
      </div>
      <!-- 02 -->
      <div class="cnt-group">
