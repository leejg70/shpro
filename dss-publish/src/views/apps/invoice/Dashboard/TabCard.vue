                ...
                <v-card-text>
                  <div class="d-flex align-start justify-space-between">
                    ...
                    <div class="d-flex align-center">
                      ...
                      <h5 class="text-body-1 font-weight-medium text-lightText mb-0 ml-1">20.3%</h5>
                    </div>
                  </div>
                </v-card-text>
              </v-card>
                ...
                <v-card-text>
                  <div class="d-flex align-start justify-space-between">
                    ...
                    <div class="d-flex align-center">
                      ...
                      <h5 class="text-body-1 font-weight-medium text-lightText mb-0 ml-1">-8.73%</h5>
                    </div>
                  </div>
                </v-card-text>
              </v-card>
                ...
                <v-card-text>
                  <div class="d-flex align-start justify-space-between">
                    ...
                    <div class="d-flex align-center">
                      ...
                      <h5 class="text-body-1 font-weight-medium text-lightText mb-0 ml-1">10.73%</h5>
                    </div>
                  </div>
                </v-card-text>
              </v-card>
                ...
                <v-card-text>
                  <div class="d-flex align-start justify-space-between">
                    ...
                    <div class="d-flex align-center">
                      ...
                      <h5 class="text-body-1 font-weight-medium text-lightText mb-0 ml-1">-4.73%</h5>
                    </div>
                  </div>
                </v-card-text>
              </v-card>
