      ...
      <v-window v-model="tab" class="mt-sm-3 mt-6">
        <v-window-item value="11">
                        ...
                        <div class="flex-1-1">
                          <div class="d-flex justify-space-between">
                            ...
                            <div class="ml-auto">
                              ...
                              <v-btn icon rounded="md" aria-label="trash" color="secondary" variant="text" size="small" class="ml-1">
          ...
          <div class="text-right mt-6">
            ...
            <v-btn variant="flat" rounded="md" color="primary" class="ml-3">Save</v-btn>
          </div>
        </v-window-item>
        ...
        <v-window-item value="33">
          <v-row>
            ...
            <v-col cols="12" class="text-right">
              ...
              <v-btn variant="flat" color="primary" rounded="md" class="ml-3">Save</v-btn>
            </v-col>
          </v-row>
        </v-window-item>
      </v-window>
