  ...
  <v-row>
    <v-col cols="12">
      <UiParentCard title="Create Invoice">
        <v-row>
          <v-col cols="12" md="4">
            <v-label class="text-subtitle-1 text-lightText mb-2">Invoice Number<span class="ml-1">*</span></v-label>
            <v-text-field
              type="text"
              color="primary"
              v-model="textinvoice"
        ...
        <v-row>
          <v-col cols="12" md="4">
            <v-label class="text-subtitle-1 text-lightText mb-2">Customer Name<span class="ml-1">*</span></v-label>
            <v-text-field
              type="text"
              color="primary"
          ...
          <v-col cols="12" md="4">
            <v-label class="text-subtitle-1 text-lightText mb-2">Customer Email<span class="ml-1">*</span></v-label>
            <v-text-field
              type="email"
              color="primary"
          ...
          <v-col cols="12" md="4">
            <v-label class="text-subtitle-1 text-lightText mb-2">Customer Contact Numer<span class="ml-1">*</span></v-label>
            <v-text-field
              type="text"
              color="primary"
          ...
          <v-col cols="12">
            <v-label class="text-subtitle-1 text-lightText mb-2">Customer Address<span class="ml-1">*</span></v-label>
            <v-text-field
              type="text"
              color="primary"
        ...
        <v-row>
          <v-col cols="12" md="6">
            <v-label class="text-subtitle-1 text-lightText mb-2">Invoice Date<span class="ml-1">*</span></v-label>
            <v-text-field
              type="text"
              color="primary"
              v-model="textdate"
          ...
          <v-col cols="12" md="6">
            <v-label class="text-subtitle-1 text-lightText mb-2">Status<span class="ml-1">*</span></v-label>
        ...
        <v-row>
          <v-col cols="12">
            <v-label class="text-subtitle-1 text-lightText mb-2">Terms and Condition:<span class="ml-1">*</span></v-label>
            <v-text-field
              type="text"
              color="primary"
              v-model="textterms"
