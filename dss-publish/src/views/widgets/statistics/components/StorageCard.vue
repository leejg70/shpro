...
<template>
  <v-row>
    <v-col cols="12">
      <v-card elevation="0" color="darkText" class="storageCard" rounded="lg">
        <v-card-item>
          ...
          <v-list class="py-0 bg-primary" aria-label="balance" aria-busy="true">
            <v-list-item class="pa-0">
              ...
              <template v-slot:append>
                <v-avatar variant="tonal" color="primary200" size="large" rounded="md">
                  <SvgSprite name="custom-bidirectional" class="text-surface" style="width: 28px; height: 28px" />
                </v-avatar>
              </template>
            </v-list-item>
          </v-list>
