  ...
  <v-row>
    <v-col cols="12" md="12">
          ...
          <UiParentCard title="Copy from TextArea">
            <div>
              ...
              <v-textarea
                ...
                v-model="textArea"
              ></v-textarea>
              <v-btn color="primary" @click="copyTextArea" variant="flat" rounded="md" class="mr-2" :disabled="isButtonDisabled()">
      ...
      <v-snackbar v-model="snackbar" color="success" variant="flat" min-width="153" :timeout="3000" location="bottom right" rounded="md">
        <v-icon class="mr-1" size="small">mdi-checkbox-marked-circle-outline</v-icon>
        Text Copied!
      </v-snackbar>
