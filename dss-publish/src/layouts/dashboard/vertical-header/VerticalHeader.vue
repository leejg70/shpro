        ...
        <v-list-item class="px-0">
          <v-card variant="outlined">
            <v-card-text>
              ...
              <p class="text-h6">You can use the Analytics Dashboard to explore how many new users download reports daily and monthly</p>
        ...
        <v-list-item class="px-0 pt-2">
          <v-card variant="outlined">
            <v-card-text>
              ...
              <p class="text-h6">You can use the Dashboard to explore how many new users download reports daily and monthly</p>
        ...
        <v-list-item class="px-0">
          <v-card variant="outlined">
            <v-card-text>
              ...
              <p class="text-h6">We've made some updates to the emendable widget which we think you are going to love.</p>
